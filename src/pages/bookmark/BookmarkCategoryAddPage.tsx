...
const schema = z.object({
  ...
  imgFile: z.string().min(1, { message: '썸네일을 선택해주세요' }),
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        {errors.imgFile && (
          <p className="text-sm text-red-500">{errors.imgFile.message}</p>
        )}
        ...
        <div className="flex flex-col gap-4">
          ...
          {errors.videos && (
            <p className="text-sm text-red-500">{errors.videos.message}</p>
          )}
